...
function classifyProductType(categorySlug, sourceCategoryName, warnings) {
  ...
  if (slug === "aksesoari-za-avtomobili") {
    ...
    warnings.push(
      `Ambiguous category "aksesoari-za-avtomobili" without an exact-known sourceCategoryName ("${sourceCategoryName || ""}") - using safe generic fallback type`
    );
